<article class="bg-white rounded-xl shadow-md overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:ring-8 hover:ring-[#000000ff] duration-300 cursor-pointer flex flex-col">
    <?php if(!empty($image)) : ?>
    ...
    <div class="p-5 flex flex-col justify-between flex-1">
        <div>
            <?php if(!empty($title)) : ?>
                <h3 class="text-xl font-bold text-black"><?= esc($title) ?></h3>
            <?php endif; ?>

            <?php if(!empty($description)) : ?>
                <p class="text-black mt-3 text-base"><?= esc($description) ?></p>
            <?php endif; ?>
            ...
            <?php if(!empty($link)) : ?>
                <a class="mt-2 underline text-black-600"><?= esc($link) ?></a>
            <?php endif; ?>
