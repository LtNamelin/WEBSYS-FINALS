...
class ProductsSeeder extends Seeder
{
    public function run()
    {
        ...
        $productsData = [
            ...
            [
                'product_name' => 'Parisian Butter Croissant',
                'product_description' => 'Buttery, flaky layers inspired by the heart of Paris.',
                'price' => 95.50,
                'type' => 'Pastry',
                'product_image' => 'https://baranbakery.com/wp-content/uploads/2024/07/Croissants-20-7-500x500.jpg',
                'created_at' => $dateNow,
                'updated_at' => $dateNow,
            ],
            [
                'product_name' => 'Nordic Cinnamon Twist',
                'product_description' => 'Soft Danish pastry rolled with warm cinnamon and sugar.',
                'price' => 110.50,
                'type' => 'Pastry',
                'product_image' => 'https://www.pipercooks.com/wp-content/uploads/2020/11/cinnamon-twist-buns-sm-6.jpg',
                'created_at' => $dateNow,
                'updated_at' => $dateNow,
            ],
            [
                'product_name' => 'Vienna Almond Strudel',
                'product_description' => 'Crispy flaky pastry filled with almonds and sweet cream.',
                'price' => 100.25,
                'type' => 'Pastry',
                'product_image' => 'https://odense.com/wp-content/uploads/2022/01/048-almond-raisin-apple-strudel-1008.jpg',
                'created_at' => $dateNow,
                'updated_at' => $dateNow,
            ],
        ];
